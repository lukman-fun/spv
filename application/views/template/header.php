		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="<?= base_url(); ?>" class="logo">
					...
					<!-- <p class="navbar-brand text-white">SPV</p> -->
					<p class="navbar-brand text-white"><img src="<?= base_url(); ?>assets/img/spvmb.jpg" alt="Logo SPV" height="45"></p>
				</a>
									...
									<li>
										<div class="user-box">
											...
											<div class="u-text">
												...
												<p class="text-muted"><?= $this->session->role; ?></p>
												<a href="<?= base_url(); ?>Logout" class="btn btn-xs btn-secondary btn-sm">Logout</a>
											</div>
										</div>
									</li>
								</div>
			...
			<div class="sidebar-wrapper scrollbar scrollbar-inner">
				<div class="sidebar-content">
					<div class="user">
						...
						<div class="info">
							<a data-toggle="collapse" href="#collapseExample" aria-expanded="true">
								<span>
									<?= $this->session->nama; ?>
									<span class="user-level"><?= $this->session->role; ?></span>
					...
					<ul class="nav nav-primary">
						<li class="nav-item <?= active_menu(''); ?> <?= active_menu('Dashboard'); ?>">
							<a href="<?= base_url(); ?>">
								<i class="fas fa-home"></i>
								<p>Home</p>
							</a>
						</li>
						<li class="nav-item <?= active_menu('Barang'); ?>">
							<a href="<?= base_url(); ?>Barang">
								<i class="fas fa-sitemap"></i>
								<p>Barang</p>
							</a>
						</li>
						<li class="nav-item <?= active_menu('History'); ?>">
							<a href="<?= base_url(); ?>History">
								<i class="fa fa-line-chart"></i>
								<p>History</p>
							</a>
						</li>
						<li class="nav-item <?= active_menu('RAPBDesa'); ?> <?= active_menu('Laporan'); ?>">
							...
							<div class="collapse" id="laporan">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="<?= base_url(); ?>Laporan/pengembalian">
											<span class="sub-item">Pengembalian</span>
										</a>
									</li>
									<li>
										<a href="<?= base_url(); ?>Laporan/perbaikan">
