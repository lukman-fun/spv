<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form action="<?= base_url(); ?>Laporan/add_perbaikan" method="POST">
                    <div class="row mx-1">
                    ...
                    <div class="row mx-1">
                        ...
                        <div class="form-group col-12 col-md-6">
                            ...
                            <input type="text" name="kerusakan" id="kerusakan" class="form-control" placeholder="Masukkan Kerusakan" required>
                        </div>
                    </div>
